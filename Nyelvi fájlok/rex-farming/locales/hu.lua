local Translations = {
    ...
    success = {
        ...
        you_harvest_label =  'Learattál: %{amount} %{label}',
    ...
    progressbar = {
        ...
        harvesting_plants = 'Ültetvény learatása...',
    ...
    blip = {
        ...
        farm_shop = 'Mezőgazdasági Bolt',
        farmzone_farm_zone = 'farmzone1 Gazdálkodási zóna',
    },
    text = {
        thirst_hunger = 'Szárazság: %{thirst} % - Trágya mennyisége: %{hunger} %',
